	...
	<div class="footer_inner clearfix">
		...
		if($display_footer_top) {
			if($footer_top_border_color != ''){ ?>
				<div class="fotter_top_border_holder <?php echo $footer_top_border_in_grid; ?>" <?php echo $footer_top_border_color; ?>></div>
			<?php } ?>
		...
		if($display_footer_text): ?>
			<div class="footer_bottom_holder">
				<?php if($footer_bottom_border_color != ''){ ?>
					<div class="fotter_top_border_holder <?php echo $footer_bottom_border_in_grid; ?>" <?php echo $footer_bottom_border_color; ?>></div>
				<?php } ?>
